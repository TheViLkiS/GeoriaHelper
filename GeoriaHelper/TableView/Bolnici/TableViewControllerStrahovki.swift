//
//  TableViewControllerStrahovki.swift
//  GeoriaHelper
//
...
class TableViewControllerStrahovki: UITableViewController {
    var countTable = 0
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return strahovki.count
    }

    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        cellSettings(tableView, place: strahovki, indexPath: indexPath)
