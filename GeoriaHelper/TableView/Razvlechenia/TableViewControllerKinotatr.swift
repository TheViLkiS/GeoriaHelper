//
//  TableViewControllerKinotatr.swift
//  GeoriaHelper
//
...
class TableViewControllerKinotatr: UITableViewController {
    var countTable = 0
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return kinoteatr.count
    }

    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        cellSettings(tableView, place: kinoteatr, indexPath: indexPath)
