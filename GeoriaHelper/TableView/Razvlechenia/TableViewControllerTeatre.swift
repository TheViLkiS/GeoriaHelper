//
//  TableViewControllerTeatre.swift
//  GeoriaHelper
//
...
class TableViewControllerTeatre: UITableViewController {
    var countTable = 0
    ...
    override func viewDidLoad() {
        ...
        font30MarkerCenter(label: topTitle, text: "Театры")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        cellSettings(tableView, place: teatre, indexPath: indexPath)
