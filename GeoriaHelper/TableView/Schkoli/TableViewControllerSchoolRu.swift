//
//  TableViewControllerSchoolRu.swift
//  GeoriaHelper
//
...
class TableViewControllerSchoolRu: UITableViewController {
    var countTable = 0
    ...
    override func viewDidLoad() {
        ...
        font30MarkerCenter(label: topTitle, text: "Русскоязычные школы")
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return schoolRU.count
    }

    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        cellSettings(tableView, place: schoolRU, indexPath: indexPath)
