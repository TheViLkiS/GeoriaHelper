//
//  TableViewControllerSchoolEng.swift
//  GeoriaHelper
//
...
class TableViewControllerSchoolEng: UITableViewController {
    var countTable = 0
    ...
    override func viewDidLoad() {
        ...
        font30MarkerCenter(label: topTitle, text: "Зарубежные школы")
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return schoolEng.count
    }

    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        cellSettings(tableView, place: schoolEng, indexPath: indexPath)
