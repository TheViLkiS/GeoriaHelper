//
//  TableViewControllerMoneyTransfer.swift
//  GeoriaHelper
//
...
class TableViewControllerMoneyTransfer: UITableViewController {
    var countTable = 0
    ...
    override func viewDidLoad() {
        ...
        font30MarkerCenter(label: topTitle, text: "Денежные переводы")
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return moneyTransfer.count
    }

    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        cellSettings(tableView, place: moneyTransfer, indexPath: indexPath)
