//
//  TableViewControllerFaqBanks.swift
//  GeoriaHelper
//
...
class TableViewControllerFaqBanks: UITableViewController {
    var countTable = 0
    ...
    override func viewDidLoad() {
        ...
        font30MarkerCenter(label: topTitle, text: "Открытие счета")
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return faqBanks.count
    }

    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        cellSettings(tableView, place: faqBanks, indexPath: indexPath)
