//
//  TableViewControllerBarbers.swift
//  GeoriaHelper
//
...
class TableViewControllerBarbers: UITableViewController {
    var countTable = 0
    ...
    override func viewDidLoad() {
        ...
        font30MarkerCenter(label: topTitle, text: "Барбер-шопы")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        cellSettings(tableView, place: barber, indexPath: indexPath)
