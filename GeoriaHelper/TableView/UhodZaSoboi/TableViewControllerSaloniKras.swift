//
//  TableViewControllerSaloniKras.swift
//  GeoriaHelper
//
...
class TableViewControllerSaloniKras: UITableViewController {
    var countTable = 0
    ...
    override func viewDidLoad() {
        ...
        font30MarkerCenter(label: topTitle, text: "Салоны красоты")
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return saloniKrasoti.count
    }

    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        cellSettings(tableView, place: saloniKrasoti, indexPath: indexPath)
