//
//  TableViewControllerSportzal.swift
//  GeoriaHelper
//
...
class TableViewControllerSportzal: UITableViewController {
    var countTable = 0
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return sportzal.count
    }
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        cellSettings(tableView, place: sportzal, indexPath: indexPath)
