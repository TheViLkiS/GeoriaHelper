//
//  TableViewControllerZoomagazin.swift
//  GeoriaHelper
//
...
class TableViewControllerZoomagazin: UITableViewController {
    var countTable = 0
    ...
    override func viewDidLoad() {
        ...
        font30MarkerCenter(label: topTitle, text: "Зоомагазины")
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return zoomagazini.count
    }
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        cellSettings(tableView, place: zoomagazini, indexPath: indexPath)
