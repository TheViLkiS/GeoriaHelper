//
//  TableViewControllerVeterinar.swift
//  GeoriaHelper
//
...
class TableViewControllerVeterinar: UITableViewController {
    var countTable = 0
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return veterinar.count
    }

    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        cellSettings(tableView, place: veterinar, indexPath: indexPath)
