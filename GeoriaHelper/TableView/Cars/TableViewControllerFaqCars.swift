//
//  TableViewControllerFaqCars.swift
//  GeoriaHelper
//
...
class TableViewControllerFaqCars: UITableViewController {
    var countTable = 0
    ...
    override func viewDidLoad() {
        ...
        font30MarkerCenter(label: topTitle, text: "FAQ")
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return faqCars.count
    }

    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        cellSettings(tableView, place: faqCars, indexPath: indexPath)
