//
//  TableViewControllerBuyCars.swift
//  GeoriaHelper
//
...
class TableViewControllerBuyCars: UITableViewController {
    var countTable = 0
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return buyCars.count
    }

    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        cellSettings(tableView, place: buyCars, indexPath: indexPath)
