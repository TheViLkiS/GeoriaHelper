//
//  TableViewControllerCarService.swift
//  GeoriaHelper
//
...
class TableViewControllerCarService: UITableViewController {
    var countTable = 0
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        cellSettings(tableView, place: carService, indexPath: indexPath)
